...
class NeuralWBCEnvCfg(DirectRLEnvCfg):
    ...
    # Visualization options. These are mostly used by playback/recording scripts and do not affect policy inputs.
    visualize_ref_motion = True
    recording_lighting = False
