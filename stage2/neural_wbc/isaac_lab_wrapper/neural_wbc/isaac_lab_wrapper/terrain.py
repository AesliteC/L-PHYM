...
RECORDING_FLAT_TERRAINS_CFG = TerrainGeneratorCfg(
    size=(20.0, 20.0),
    border_width=0.0,
    num_rows=1,
    num_cols=1,
    ...
    use_cache=False,
    sub_terrains={
        "flat": terrain_gen.MeshPlaneTerrainCfg(proportion=1.0, size=(20.0, 20.0)),
    },
)

recording_flat_terrain = TerrainImporterCfg(
    prim_path="/World/ground",
    terrain_type="generator",
    terrain_generator=RECORDING_FLAT_TERRAINS_CFG,
    ...
    visual_material=sim_utils.PreviewSurfaceCfg(
        diffuse_color=(0.015, 0.016, 0.018),
        roughness=0.92,
    ),
    debug_vis=False,
)
