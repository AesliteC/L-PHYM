...
def _get_default_motion_path() -> str:
    for rel_path in ("motions/five_pos.pkl", "motions/stable_punch_1.pkl", "motions/stable_punch.pkl"):
        try:
            return get_data_path(rel_path)
        except FileNotFoundError:
            continue
    raise FileNotFoundError(
        "Could not find a default H1 motion file. Expected one of: "
        "motions/five_pos.pkl, motions/stable_punch_1.pkl, motions/stable_punch.pkl."
    )
...
class NeuralWBCEnvCfgH1(NeuralWBCEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.reference_motion_manager.motion_path = _get_default_motion_path()
